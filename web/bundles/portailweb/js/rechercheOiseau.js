		...
		if(document.getElementById('tabObservations') != null) {
			...
			for(var i = 0; i < nbObservations; i++) {
				...
				marker = new google.maps.Marker({
					...
					map: map,	
					info: '<div id="container"><div class="infoContent"><h3>Position</h3><hr>Latitude : ' + observations[i].latitude + ' <br>Longitude : ' + observations[i].longitude + '</div><div class="infoContent"><h3>Nombre</h3><hr>' + observations[i].nbIndividus + ' individu(s)</div><div class="infoContent"><h3>Commentaire</h3><hr>' + observations[i].commentaire + '</div><div class="infoContent"><h3>Photo</h3><hr><img src="/projet-6/web/uploads/photos/' + observations[i].photo + '" class="photoOiseau" /></div></div>',
					icon : "/projet-6/web/images/locator.png"
					});
