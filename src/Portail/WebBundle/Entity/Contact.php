 ...
 * @ORM\Entity(repositoryClass="Portail\WebBundle\Repository\ContactRepository")
 */
class Contact
{
    /**
     ...
     * @Assert\Email(
     *     message = "L'e-mail '{{ value }}' est invalide.",
     *     checkMX = true
     * )
     */
    private $email;
     ...
     *      maxMessage = "Le message doit faire au plus {{ limit }} caractères"
     * )
     */
    private $message;
